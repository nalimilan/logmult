print.rc <- function(x, ...) {
  ...
  print(round(ass$phi[1,], d=3))
  cat("\nNormalized row scores:\n")
  print(round(ass$row[,,1], d=3))
  cat("\nNormalized column scores:\n")
  print(round(ass$col[,,1], d=3))
  ...
  cat("Deviance:", round(x$deviance, d=3), "\n")
